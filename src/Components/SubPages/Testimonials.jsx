...
const Testimonials = () => {
  ...
  return (
    <div>
      <div className="sm:w-full bg-color2 rounded-3xl lg:h-[350px] lg:w-[460px] lg:mx-auto h-auto space-y-3 p-2 lg:mb-5 mx-5 relative">
        <div className="text-center py-5 space-x-2 text-orange">
          <FontAwesomeIcon icon={faUser} className="text-2xl" />
          <span className="text-xl font-semibold">Testimonials</span>
        </div>
        <hr className="text-black" />
        <div className="bg-color2 lg:h-[250px] h-[300px] p-6 relative">
          <Slider {...settings}>
                ...
                <div className="bg-color2 shadow1 rounded-3xl w-full text-left lg:h-[190px] md:h-[170px] h-auto mt-16">
                  ...
                  <div className="text-gray2 text-lg lg:text-xl flex flex-wrap justify-between items-center h-28 mx-4">
                    <img
                      src={item.img}
                      alt=""
                      className="w-20 h-20 bg-red-500 rounded-full bg-contain"
                    />
                    <h1 className="text-[18px] text-textcolor lg:w-[200px] text-center">
                      {item.name}
                    </h1>
